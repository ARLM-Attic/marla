...
*/
var parser = (function(){
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,8],$V1=[1,7],$V2=[5,6],$V3=[1,15],$V4=[1,16],$V5=[1,23],$V6=[1,37],$V7=[1,36],$V8=[1,44],$V9=[1,40],$Va=[1,41],$Vb=[1,42],$Vc=[1,43],$Vd=[1,35],$Ve=[1,48],$Vf=[1,51],$Vg=[1,49],$Vh=[1,50],$Vi=[1,52],$Vj=[1,53],$Vk=[5,11,13],$Vl=[1,59],$Vm=[1,64],$Vn=[5,6,32,35,97,100],$Vo=[1,68],$Vp=[5,6,32,35,43,57,60,61,68,93,97,100],$Vq=[1,69],$Vr=[5,6,32,35,43,57,60,61,68,92,93,97,100],$Vs=[1,70],$Vt=[5,6,32,35,43,57,60,61,68,90,92,93,97,100],$Vu=[1,71],$Vv=[1,73],$Vw=[1,72],$Vx=[1,74],$Vy=[5,6,21,23,32,35,43,57,60,61,68,87,88,90,92,93,97,100],$Vz=[1,76],$VA=[1,75],$VB=[5,6,21,23,32,35,43,57,60,61,68,78,85,87,88,90,92,93,97,100],$VC=[1,77],$VD=[1,78],$VE=[5,6,21,23,32,35,43,57,60,61,68,78,82,83,85,87,88,90,92,93,97,100],$VF=[2,87],$VG=[1,80],$VH=[5,6,21,23,30,32,35,43,49,57,60,61,68,78,82,83,85,87,88,90,92,93,97,100],$VI=[10,26,42,71,72,73,74,78],$VJ=[2,70],$VK=[1,86],$VL=[5,11,13,23,32,35,43,46,47],$VM=[1,89],$VN=[1,90],$VO=[5,11,13,23,32,35,43,46,47,48,49,53],$VP=[32,35],$VQ=[23,35],$VR=[1,113],$VS=[43,68],$VT=[1,159],$VU=[1,157],$VV=[1,158],$VW=[5,6,32,35,68,97,100],$VX=[1,179],$VY=[1,177],$VZ=[1,194],$V_=[5,6,32,35,43,68,97,100],$V$=[5,11],$V01=[2,20],$V11=[1,202],$V21=[5,10,11,13,30],$V31=[1,214],$V41=[2,22],$V51=[1,222],$V61=[1,238];
...
terminals_: {2:"error",5:"LF",6:"EOF",10:"IDENTIFIER",11:"=",13:":",16:"TYPE",17:"NOTIMPL",18:"INDENT",20:"OUTDENT",21:"<",23:">",26:"!",29:"|",30:"(",32:")",35:",",39:"SQ",42:"{",43:"}",45:"[",46:"]",47:"\\",48:"?",49:".",53:"ARROW",57:"WHERE",60:"IF",61:"ELSE",68:";",71:"FLOAT",72:"INT",73:"BOOL",74:"STRING",78:"-",82:"*",83:"/",85:"+",87:"LE_OP",88:"GE_OP",90:"EQ_OP",92:"LOGICAL_AND_OP",93:"LOGICAL_OR_OP",97:"ASSIGN_OP",99:"FOR",100:"RANGE"},
productions_: [0,[3,3],[3,2],[3,1],[7,1],[7,1],[4,1],[4,3],[9,3],[9,5],[9,4],[9,6],[8,4],[8,9],[8,12],[19,1],[19,3],[25,1],[25,2],[27,2],[27,0],[28,2],[28,0],[24,2],[24,5],[24,4],[24,3],[24,4],[15,1],[15,3],[15,2],[33,1],[33,3],[34,1],[34,3],[31,1],[31,3],[37,3],[38,2],[22,1],[22,3],[14,1],[36,1],[36,4],[36,2],[36,5],[36,3],[36,3],[36,3],[36,3],[36,2],[36,2],[36,3],[50,1],[44,1],[44,3],[51,1],[41,1],[41,3],[52,1],[40,1],[40,3],[12,1],[12,6],[54,1],[54,3],[54,8],[54,5],[62,1],[62,5],[63,1],[63,1],[63,1],[66,3],[67,1],[67,3],[69,3],[70,1],[70,3],[65,3],[65,9],[64,1],[64,1],[64,1],[64,1],[75,1],[75,3],[76,1],[76,2],[77,1],[77,1],[79,1],[79,3],[80,1],[80,4],[80,3],[81,1],[81,3],[81,3],[84,1],[84,3],[84,3],[86,1],[86,3],[86,3],[86,3],[86,3],[89,1],[89,3],[91,1],[91,3],[56,1],[56,3],[94,3],[58,1],[58,3],[95,3],[59,1],[59,3],[96,1],[96,3],[96,1],[96,8],[96,12],[55,1],[55,3],[98,3],[98,5]],
...
rules: [/^(?:(\/\/.*?)((\r?\n)))/,/^(?:[\t ])/,/^(?:(\r?\n))/,/^(?:»)/,/^(?:«)/,/^(?:\.\.\.)/,/^(?:\.\.<)/,/^(?:type\b)/,/^(?:for\b)/,/^(?:if\b)/,/^(?:else\b)/,/^(?:where\b)/,/^(?:->)/,/^(?:[0-9]+\b)/,/^(?:[0-9]+(\.[0-9]+)\b)/,/^(?:"(\\.|[^"])*")/,/^(?:[a-zA-Z_]\w*)/,/^(?:==)/,/^(?:>=)/,/^(?:<=)/,/^(?:<-)/,/^(?:!)/,/^(?:\.)/,/^(?:\*)/,/^(?:\/)/,/^(?:-)/,/^(?:\+)/,/^(?:\^)/,/^(?:=)/,/^(?:\()/,/^(?:\))/,/^(?:<)/,/^(?:>)/,/^(?:\{)/,/^(?:\})/,/^(?:\[)/,/^(?:\])/,/^(?:\\)/,/^(?::)/,/^(?:;)/,/^(?:\|)/,/^(?:,)/,/^(?:\?)/,/^(?:')/,/^(?:$)/,/^(?:.)/],
